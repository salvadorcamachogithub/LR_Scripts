...
Action()
{
	...
	lr_start_transaction("AOS-TruClient-S01-01 Access AOS URL");
	truclient_step("2", "Navigate to AOS_URL", "snapshot=Action_2.inf");
	lr_end_transaction("AOS-TruClient-S01-01 Access AOS URL",0);
	truclient_step("3", "Wait Math.floor(Math.random() * (26- 15) + 15) seconds", "snapshot=Action_3.inf");
	lr_start_transaction("AOS-TruClient-S01-02 Go To Speakers");
	truclient_step("4", "Click on SPEAKERS", "snapshot=Action_4.inf");
	lr_end_transaction("AOS-TruClient-S01-02 Go To Speakers",0);
	truclient_step("5", "Wait Math.floor(Math.random() * (26- 15) + 15) seconds", "snapshot=Action_5.inf");
	lr_start_transaction("AOS-TruClient-S01-03 Random Product");
	truclient_step("6", "Click on Random Product", "snapshot=Action_6.inf");
	lr_end_transaction("AOS-TruClient-S01-03 Random Product",0);
